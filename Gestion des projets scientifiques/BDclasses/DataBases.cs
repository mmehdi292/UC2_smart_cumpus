...
namespace Gestion_des_chercheurs.BDclasses
{
    class DataBases
    {
        ...
        public bool AddChercheurProjet(int id, string user)
        {
            //username, id_projet
            string query = "INSERT INTO projetchercheur (id_projet,username) VALUES(@id_projet, @username);";
            if (this.OpenConnection() == true)
            {
                //MySqlCommand cmd = connection.CreateCommand();
                try
                {
                    var cmd = new MySqlCommand(query, connection);
                    cmd.CommandText = query;
                    cmd.Parameters.AddWithValue("@id_projet", id);
        ...
        public bool AddChercheurPRFU(int id, string user)
        {
            //username, id_projet
            string query = "INSERT INTO projetprfuchercheur (id_projet,username) VALUES(@id_projet, @username);";
            if (this.OpenConnection() == true)
            {
                //MySqlCommand cmd = connection.CreateCommand();
                try
        ...
        public bool AddFilePRFU(int id, Byte[] file)
        {
            //username, id_projet
            string query = "INSERT INTO fichierprfu (fichier, id) VALUES(@fichier, @id);";
            if (this.OpenConnection() == true)
            {
                //MySqlCommand cmd = connection.CreateCommand();
                try
        ...
        public bool AddFileProjet(int id, Byte[] file)
        {
            string query = "INSERT INTO fichierprojet (fichier, id) VALUES(@fichier, @id);";
            if (this.OpenConnection() == true)
            {
                //MySqlCommand cmd = connection.CreateCommand();
                try
